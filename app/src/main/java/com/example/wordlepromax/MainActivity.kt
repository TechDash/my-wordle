...
class MainActivity : AppCompatActivity() {
    ...
    fun validate(view: View?) {
        ...
        if (attempt > 7) {
            ...
            val comparison = compareWords(answer, word)
    ...
    private fun compareWords(word1: String, word2: String): ArrayList<String> {
        ...
        for (i in word1.indices) {
            ...
            if (word1[i] == word2[i]) output[i] = "yes"
